...
var LSTHoldingsService = class extends BaseHoldingsService {
  ...
  async getXSTRKHoldings(address, blockNumber) {
    ...
    const lstContract = new starknet.Contract(erc4626_abi_default, this.config.xSTRK.address, this.provider);
...
var EKUBO_API_QUERY = client.gql`
...
var EkuboHoldingsService = class extends BaseHoldingsService {
  ...
  async getEkuboHoldings(address, blockNumber) {
    ...
    const positionContract = new starknet.Contract(
...
var NostraLendingHoldingsService = class extends BaseHoldingsService {
  ...
  async getVaultHoldings(address, vaultType, blockNumber) {
    ...
    const contract = new starknet.Contract(erc4626_abi_default, contractConfig.address, this.provider);
...
var NostraDexHoldingsService = class extends BaseHoldingsService {
  ...
  async getLPHoldings(address, blockNumber) {
    ...
    const contract = new starknet.Contract(nostra_lp_abi_default, lpConfig.address, this.provider);
    const balance = await contract.call("balance_of", [address], {
      blockIdentifier: blockNumber ?? "latest"
    });
...
var OpusHoldingsService = class extends BaseHoldingsService {
  ...
  async getOpusHoldings(address, blockNumber) {
    ...
    const contract = new starknet.Contract(opus_abi_default, this.config.contract.address, this.provider);
...
var STRKFarmSenseiHoldingsService = class extends BaseHoldingsService {
  ...
  async getSenseiHoldings(address, blockNumber) {
    ...
    const contract = new starknet.Contract(sensei_abi_default, this.config.contracts.xSTRKSensei.address, this.provider);
...
var STRKFarmEkuboHoldingsService = class extends BaseHoldingsService {
  ...
  async getEkuboSTRKFarmHoldings(address, blockNumber) {
    ...
    const contract = new starknet.Contract(ekubo_strkfarm_abi_default, this.config.contracts.ekuboXSTRKSTRK.address, this.provider);
...
var VesuHoldingsService = class extends BaseHoldingsService {
  ...
  async getVaultHoldingsByType(address, vaultType, vaultConfig1, vaultConfig2, blockNumber) {
    ...
    for (const token of vTokens) {
      const contract = new starknet.Contract(erc4626_abi_default, token, this.provider);
      ...
      const contractV2 = new starknet.Contract(erc4626_abi_default, assetsToken, this.provider);
  ...
  async getCollateralHoldings(address, blockNumber) {
    ...
    for (const pool of pools) {
      ...
      try {
        const contract = new starknet.Contract(vesu_singleton_abi_default, singletonAddress, this.provider);
...
exports.BaseHoldingsService = BaseHoldingsService;
exports.CONTRACTS = CONTRACTS;
exports.CONTRACT_NAMES = CONTRACT_NAMES;
exports.DEFAULT_API_TIMEOUT = DEFAULT_API_TIMEOUT;
exports.DEFAULT_NETWORK = DEFAULT_NETWORK;
exports.DEFAULT_TIMEOUT = DEFAULT_TIMEOUT;
exports.EkuboHoldingsService = EkuboHoldingsService;
exports.EndurSDK = EndurSDK;
exports.HoldingsManager = HoldingsManager;
exports.LSTHoldingsService = LSTHoldingsService;
exports.LSTService = LSTService;
exports.MAX_RETRIES = MAX_RETRIES;
exports.NETWORKS = NETWORKS;
exports.NostraDexHoldingsService = NostraDexHoldingsService;
exports.NostraLendingHoldingsService = NostraLendingHoldingsService;
exports.OpusHoldingsService = OpusHoldingsService;
exports.RETRY_DELAY = RETRY_DELAY;
exports.STRKFarmEkuboHoldingsService = STRKFarmEkuboHoldingsService;
exports.STRKFarmSenseiHoldingsService = STRKFarmSenseiHoldingsService;
exports.StarknetService = StarknetService;
exports.VesuHoldingsService = VesuHoldingsService;
